            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    <?php foreach ($artikel as $value) : ?>
                        <!-- form start -->
                        <form role="form" id="form_artikel" action="<?php echo base_url('artikel/ubah_artikel/'.$value->id); ?>">
                            <!-- /.callout -->
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="box">
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-header">
                                                <h3 class="box-title">Masukan Perubahan Artikel</h3>
                                            </div>
                                            <!-- /.box-header -->
                                            <div class="box-body">
                                                <div class="col-md-12">
                                    ...
                                    <div class="box box-primary">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="kategori" class="form-control auto_select" value="<?php echo $value->kategori; ?>">
