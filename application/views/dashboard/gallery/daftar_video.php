    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Album Video Gallery
                <a href="<?php echo base_url('/gallery/tambah_album_video/'); ?>" class="btn btn-primary">
                    Tambah Album Baru
                </a>
            </h1>
            <ol class="breadcrumb">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary" href="<?php echo base_url('gallery/ubah_album_video/'. $gallery->id); ?>">
...
<script type="text/javascript">
    ...
    function reinitDataTable() {
        $.ajax({
            url : baseUrl+'gallery/album_video_ajax_table'
        }).done(function(r) {
    ...
    function deleteField(id) {
        ...
        if (resultConfirm) {
            $('#loader').show();
            $.ajax({
                url : baseUrl+'gallery/hapus_album_video/'+id,
                dataType : 'JSON'
            }).done(function(r) {
                reinitDataTable();
                $('#loader').hide();
