            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <!-- form start -->
                    <form role="form" id="form_album" action="<?php echo base_url('gallery/update_gallery_video/'.$gallery->id); ?>">
                        <!-- /.callout -->
                        <div class="row">
                            <div class="col-md-10">
                                <div class="box">
                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="preview-image">
                                                        <div class="preview">
                                                            <div class="icon-group">
                                                                <a href="javascript:void(0);" class="btn btn-danger remove" dataimage="<?php echo $gallery->cover_album; ?>"><i class="fa fa-remove"></i></a>
                                                            </div>
                                                            <img src="<?php echo base_url(get_link_foto($gallery->cover_album)); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Custom Video URL -->
                                                ...
                                                <div class="form-group">
                                                    <div class="form-builder">
                                                        <?php
                                                            $video_url = unserialize($gallery->links_url);
                                                            if ($video_url) :
                                                        ...
                                                        ?>
                                                            <div class="item-field col-md-12">
                                                                <div class="col-md-10 col-sm-10 form-group">
                                                                    ...
                                                                    <input type="text" placeholder="Masukan URL video" class="form-control" name="link_videos[]" value="<?php echo $video; ?>" required>
                                                                </div>
                                                                <div class="col-md-2">
