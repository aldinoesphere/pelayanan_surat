            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="<?php echo base_url('kartu_keluarga/details/'.$no_kk); ?>">Details</a></li>
                        <li class="active">Tambah data anggota keluarga</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box box-primary">
                                    ...
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <form role="form" id="form_ak" action="<?php echo base_url('kartu_keluarga/simpan_ak'); ?>">
                                        <div class="box-body">
                                            <div class="col-md-6">
