        ...
        <section class="content container-fluid">
                    ...
                    <div class="box">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Form Kelengkapan Dokumen</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Data Kelengkapan Dokumen</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="kartu_keluarga" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>NO</th>
                                        <th>NAMA KELENGKAPAN DOKUMEN</th>
                                        <th>JENIS DOKUMEN</th>
                                        <th>AKSI</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        $i = 1;
                                        foreach ($kelengkapan_dokumen as $kelengkapan) {
                                    ?>
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $kelengkapan->nama_kelengkapan; ?></td>
