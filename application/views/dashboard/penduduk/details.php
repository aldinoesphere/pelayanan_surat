                    ...
                    <div class="box box-warning">
                        <div class="box-body box-profile">
                            <?php foreach ($penduduk as $ak) : ?>
                                ...
                                <a href="<?php echo base_url('penduduk/ubah_penduduk/'.$ak->nik); ?>" class="btn btn-primary btn-block"><b><i class="fa fa-pencil"></i> Kelola Penduduk</b></a>
                                <a href="<?php echo base_url('penduduk'); ?>" class="btn btn-info btn-block"><b><i class="fa fa-reply"></i> Kembali</b></a>
                            <?php endforeach; ?>
                        </div>
                    </div>
                </div>
