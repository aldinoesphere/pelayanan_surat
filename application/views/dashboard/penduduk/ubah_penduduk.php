                            ...
                            <div class="box">
                                ...
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <h3 class="box-title">Form ubah data Penduduk</h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <form role="form" id="form_penduduk" action="<?php echo base_url('penduduk/ubah'); ?>">
                                    <?php foreach ($penduduk as $data_penduduk) :?>
                                        <div class="box-body">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="no_kk">NO KK</label>
                                                    <select class="form-control select2 auto_select" name="no_kk" id="no_kk" value="<?php echo $data_penduduk->no_kk; ?>" required>
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <a href="<?php echo base_url('penduduk'); ?>" class="btn btn-info"> <i class="fa fa-reply"></i> KEMBALI</a>
                                        </div>
                                    <?php endforeach; ?>
                                    </form>
                                </div>
